...
namespace _20191121_SP
{
    public partial class FrmSistemaSolar : Form
    {
        ...
        /// <summary>
        /// En el constructor deberán instanciarse los atributos planetas, animaciones y xml.
        /// </summary>
        ...
        /// <summary>
        /// Asociar el manejador con el evento de cada planeta instanciado.
        /// Preguntar si existe el archivo planetas (método FileExists de Xml), 
        /// en cuyo caso se deberá leer el mismo y cargar la ubicación de los planetas.
        /// </summary>
        ...
        /// <summary>
        /// Agregar un foreach, donde dentro se deberá:
        /// Crear los hilos para el método AnimarSistemaSolar (un hilo por cada planeta).
        /// Agregar dicho hilo a la lista de animaciones
        /// Iniciar cada hilo.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// Debe lograr que se llame al hilo principal al mismo método, 
        /// para que este pueda llamar a this.CalcularUbicacion.
        /// </summary>
        ...
        private void DibujarAvancePlaneta(object sender, PlanetaEventArgs e)
        {
            ...
            {
                this.CalcularUbicacion(pic.Location, e.Avance, e.RadioRespectoSol);
            }
            else
            {
